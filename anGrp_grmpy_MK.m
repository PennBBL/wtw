function [] = anGrp_grmpy_MK()
% analyze results of a wtw experiment

cd /data/jux/BBL/studies/grmpy/processedNeuroec/wtw/
% set path to subfunctions
addpath('/data/jux/BBL/studies/grmpy/processedNeuroec/wtw/scripts');
addpath('/data/jux/BBL/studies/grmpy/processedNeuroec/wtw/scripts/subFx_analysis');
addpath('/data/jux/BBL/studies/grmpy/processedNeuroec/wtw/scripts/subFx_load');
...
!Rscript /data/jux/BBL/studies/grmpy/processedNeuroec/wtw/scripts/txtOutputProcesser_grmpy.R
