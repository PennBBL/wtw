...
% Mack added: export dates as .txt
datesmat=cell2mat(alldates.grmpy);
datesmat=str2num(datestr(datesmat,'yyyymmdd'));
if exist('datesmat.txt', 'file')==2
  delete('datesmat.txt');
end
diary('/data/jux/BBL/studies/grmpy/processedNeuroec/wtw/datesmat.txt');disp(datesmat);diary off;
