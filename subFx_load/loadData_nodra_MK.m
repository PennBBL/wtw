function [grpData] = loadData_nodra_MK()
...
!ls /data/joy/BBL/studies/reward/rawNeuroec/wwt/*.mat > wtwFilenames_nodra.txt
%!ls /data/joy/BBL/studies/grmpy/rawNeuroec/*/*/*qtask.mat > wtwFilenames.txt

% load .txt file with paths
FileNames = importdata('wtwFilenames_nodra.txt');
